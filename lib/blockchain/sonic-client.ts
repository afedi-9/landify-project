...
const SONIC_RPC_URL = process.env.NEXT_PUBLIC_SONIC_RPC_URL || "https://sonic-rpc.example.com"
const SONIC_CHAIN_ID = Number.parseInt(process.env.NEXT_PUBLIC_SONIC_CHAIN_ID || "1001")
const SONIC_EXPLORER_URL = process.env.NEXT_PUBLIC_SONIC_EXPLORER_URL || "https://explorer.sonic.network"
